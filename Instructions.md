...
- Your login: is mfwsuser18@demo.broadcom.com
...
- Your userid is CUST018.
- Your password CUST018.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS18 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS18 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST018.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST018.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST018
Password: Mfuser18@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-18.git`
